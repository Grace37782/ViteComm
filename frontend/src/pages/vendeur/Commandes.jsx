      ...
      <div className="relative overflow-hidden px-5 pt-5 pb-5"
        ...
        <div className="relative z-10 flex items-center gap-3 mb-4">
          ...
          <div className="flex-1">
            <div className="text-white font-black text-base">Gestion des commandes</div>
            <div className="text-white/70 text-xs">
              Vérifiez le code livreur avant la remise
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 flex gap-2">
          {[
            ...
            <button key={f.id} onClick={() => setFiltre(f.id)}
              ...
              style={{
                background:  filtre === f.id ? '#fff' : 'rgba(255,255,255,0.15)',
                color:       filtre === f.id ? '#BA7517' : '#fff',
                border:      `1px solid ${filtre === f.id ? '#fff' : 'rgba(255,255,255,0.3)'}`,
              }}>
              {f.label}
            </button>
          ))}
                ...
                <div className="px-4 pb-4 flex flex-col gap-3"
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      ...
                      style={{
                        background:   '#FAFAF7',
                        border:       `1.5px solid ${errCodes[cmd.id] ? '#E24B4A' : codeSaisi ? '#1D9E75' : '#E8E6DF'}`,
                        color:        '#2C2C2A',
                  ...
                  <button
                    ...
                    style={{
                      background: peutValider ? '#1D9E75' : '#D3D1C7',
                      border:     'none',
                      cursor:     peutValider ? 'pointer' : 'not-allowed',
                      boxShadow:  peutValider ? '0 4px 16px rgba(29,158,117,0.3)' : 'none',
                    }}>
                    {!codeSaisi
