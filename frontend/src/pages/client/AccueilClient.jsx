      ...
      {popularProducts.length > 0 && (
        <div className="px-4 mb-6">
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              onClick={() => vendors.length > 0 && navigate('/client/catalogue/marche' + vendors[0].id_user)}
          ...
          <div className="grid grid-cols-3 gap-3">
            {popularProducts.map((p) => (
              <button
                key={p.id_produit}
                onClick={() => p.vendeur?.id_user && navigate('/client/catalogue/marche' + p.vendeur.id_user)}
